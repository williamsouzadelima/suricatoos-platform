...
Two Suricatoos CISO features are tailored to ISO 27001 deliverables: the **Statement of Applicability** report, and the **issues and objectives** registers used to satisfy the context-of-organisation requirements.
...
Suricatoos CISO generates the SoA from an existing audit:

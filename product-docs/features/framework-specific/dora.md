...
The EU [Digital Operational Resilience Act](https://www.eiopa.europa.eu/digital-operational-resilience-act-dora_en) (DORA) imposes two specific reporting obligations that Suricatoos CISO produces out of the box: the **Register of Information** on ICT third-party arrangements, and structured **major incident reports** filed with the supervisory authority.
...
Suricatoos CISO builds this register from the entities, solutions, and contracts you already track in the **third-party risk** module:
...
Suricatoos CISO ships a dedicated **DORA incident report** object:

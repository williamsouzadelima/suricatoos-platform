...
5.  Fill **ACS URL** with `<base_url>/api/accounts/saml/0/acs/`, enter the **Entity ID** which has to be the same than <mark style="color:purple;">**SP entity Id**</mark> in Suricatoos CISO (**ciso-assistant** by default) and choose **Email** in **Name ID Format**<br>

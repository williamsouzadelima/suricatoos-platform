...
CIS Controls and the Cloud Security Alliance's Cloud Controls Matrix (CCM) ship as Excel spreadsheets that Suricatoos CISO can convert and load directly — no command-line preparation required.

{% hint style="info" %}
CIS and CSA have restrictive licence terms on their content, so the spreadsheets are not bundled with Suricatoos CISO. You have to download the official spreadsheet from CIS or CSA yourself and then upload it to the platform.
{% endhint %}

## Direct import

1. Download the CIS Controls or CCM spreadsheet from the relevant authority's website.
2. In Suricatoos CISO, go to **Libraries** and click **Add your own library**.

   <figure><img src="../../.gitbook/assets/image.png" alt=""><figcaption></figcaption></figure>
3. Select the downloaded spreadsheet and upload it. Suricatoos CISO converts it to the platform's library format on the fly.

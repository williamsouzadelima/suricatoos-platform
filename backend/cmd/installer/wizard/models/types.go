...
const (
	...
	InstallSuricatoosScreen      ScreenID = "processor_operation_form§all§install"
	StartSuricatoosScreen        ScreenID = "processor_operation_form§all§start"
	StopSuricatoosScreen         ScreenID = "processor_operation_form§all§stop"
	RestartSuricatoosScreen      ScreenID = "processor_operation_form§all§restart"
	...
	UpdateSuricatoosScreen       ScreenID = "processor_operation_form§compose§update"
	...
	RemoveSuricatoosScreen       ScreenID = "processor_operation_form§all§remove"
	PurgeSuricatoosScreen        ScreenID = "processor_operation_form§all§purge"

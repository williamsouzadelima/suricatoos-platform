...
import (
	...
	"suricatoos/cmd/installer/hardening"
	"suricatoos/cmd/installer/state"
	"suricatoos/cmd/installer/wizard"
...
func parseFlags(args []string) Config {
	...
	flagSet.Usage = func() {
		fmt.Fprintf(os.Stderr, "Suricatoos Installer v%s\n\n", version.GetBinaryVersion())
...
func createInitialEnvFile(path string) error {
	...
	content = fmt.Appendf(nil, `# Suricatoos Environment Configuration
# Generated by Suricatoos Installer v%s
#
# This file contains environment variables for Suricatoos configuration.
...
func printStartupInfo(envPath string, checkResult checker.CheckResult) {
	fmt.Printf("Suricatoos Installer v%s\n", version.GetBinaryVersion())

"""
Convert Library v2 - Build a Suricatoos CISO YAML library from a v2 Excel file
...
# Maximum length for 'name' fields as enforced by the Suricatoos CISO database.
NAME_MAX_LENGTH = 200

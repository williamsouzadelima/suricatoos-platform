            ...
            for os_data in data.get("operational_scenarios", []):
                ...
                if first_ap is None:
                    ...
                    _warn(
                        ...
                        os_name,
                        "no importable attack path; Suricatoos CISO requires one",
                        os_data.get("id", ""),
                    )
                    continue
                    ...
                    match on_conflict:
                        ...
                        case _:
                            ...
                            _warn(
                                "operational_scenario",
                                os_name,
                                f"attack path '{first_ap.name}' is already linked to another OS (Suricatoos CISO enforces one OS per attack path)",
                                os_data.get("id", ""),
                            )
                            continue

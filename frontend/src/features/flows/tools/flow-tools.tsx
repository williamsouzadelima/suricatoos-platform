                                ...
                                <FormControl>
                                    <InputGroup className="flex-1">
                                        ...
                                        <InputGroupInput
                                            {...field}
                                            autoComplete="off"
                                            placeholder={t('Search tool logs...')}
                                            type="text"
                                        />
                                        {field.value && (
            ...
            {hasLogs ? (
                ...
                <Empty>
                    <EmptyHeader>
                        ...
                        <EmptyTitle>{t('No search logs found')}</EmptyTitle>
                ...
                <Empty>
                    <EmptyHeader>
                        ...
                        <EmptyTitle>{t('No search logs available')}</EmptyTitle>
                        <EmptyDescription>
                            {t('Search logs will appear here when the agent performs searches')}
                        </EmptyDescription>
                    </EmptyHeader>
                </Empty>
            )}
